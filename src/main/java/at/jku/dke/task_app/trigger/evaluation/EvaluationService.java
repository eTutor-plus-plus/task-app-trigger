...
public class EvaluationService {
     ...
     */
    public EvaluationService(TriggerTaskRepository taskRepository, MessageSource messageSource) {
    ...
    public GradingDto evaluate(SubmitSubmissionDto<TriggerSubmissionDto> submission) {
        ...
        return new GradingDto(task.getMaxPoints(), BigDecimal.ZERO, "Not yet implemented", new ArrayList<>());
    }
}
