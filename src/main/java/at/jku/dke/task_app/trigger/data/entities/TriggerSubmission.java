...
public class TriggerSubmission extends BaseSubmission<TriggerTask> {
     ...
     */
    public TriggerSubmission(String submission) {
     ...
     * @param submission    The input.
     */
    public TriggerSubmission(String userId, String assignmentId, TriggerTask task, String language, int feedbackLevel, SubmissionMode mode, String submission) {
